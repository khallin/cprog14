...
public:
	String name;
	String[] usedOn; // A list of items this item can be used on
	//A map of string with items that can be used with this item
	String[] usedMessages; 	// First message if used alone, and following are message when
	...
	String usedMessage() = 0;	// Get message from use i.e. the game says "The item: grapefruit, was used on: stove". 
